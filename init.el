...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (imenu-list markdown-mode paredit paredit-mode fsharp-mode haskell-mode ess evil projectile swiper ivy spaceline ido-vertical-mode exwm beacon use-package))))
(custom-set-faces
